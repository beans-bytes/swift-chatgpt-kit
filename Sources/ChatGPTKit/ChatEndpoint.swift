...
extension Endpoint where Output == ChatCompletionStreamingResponse {
    static func chatCompletionStreaming(apiKey: String, request: ChatCompletionRequest) throws -> Self {
        guard !apiKey.isEmpty else {
            throw ChatGPTKitError.invalidApiToken
        }
